#!/bin/bash
#SBATCH --job-name=yolo26s_uni1280
...
# ==============================================================================
# Unified Champion Model (1280px Native Resolution Variant)
# Combines:
# 1. Native High Resolution (imgsz=1280) - Triples micro-capacitor pixel density
# 2. Micro-Capacitor Copy-Paste Data Augmentation (balances sparse PCB boards)
# 3. Loss Reweighting (cls=1.5, box=5.0, dfl=2.0, label_smoothing=0.1)
# ==============================================================================
...
# 3. Train Unified Champion Model (1280px)
python train.py \
    --run-key yolov26s_unified_1280 \
    --weights yolo26s.pt \
